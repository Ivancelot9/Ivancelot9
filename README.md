# 💫 About Me:
🎮 Desarrollador de Videojuegos | 💻 Programador | 🎓 Estudiante Universitario<br><br>Creando y Desarrollando experiencias interactivas a través de los videojuegos.<br>Actualmente perfeccionando mis habilidades en programación en la universidad. <br>¡Siempre dispuesto a aprender y colaborar en proyectos emocionantes relacionados con programación!<br><br>🌟 Habilidades:<br>- Hard Skills: Unity, C#, C++, Visual Studio,  AR/VR, Git/GitHub.<br>- Soft Skills: Liderazgo, Disciplina, Trabajo en equipo.<br><br>🚀 Proyectos universitarios: "Perdido en el Mictlán y más prototipos.<br>📚 Aprendiendo: Algoritmos avanzados, IA, realidad aumentada, etc.<br><br>Estoy en busca de prácticas y abierto a explorar otras áreas más allá de los videojuegos, como ciberseguridad y desarrollo web.<br> Me interesa expandir mis conocimientos y habilidades en estas áreas para poder colaborar con empresas de Desarrollo de Software.
